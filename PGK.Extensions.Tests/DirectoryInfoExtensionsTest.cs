...
namespace PGK.Extensions.Tests
{
    ...
    public class DirectoryInfoExtensionsTest
	{
		...
		public void FindFileRecursive_pattern()
		{
			...
			Assert.IsTrue(results.FullName.EndsWith(System.IO.Path.DirectorySeparatorChar + @"Properties" + System.IO.Path.DirectorySeparatorChar + "AssemblyInfo.txt"));
		}
		[TestMethod]
		...
		public void FindFilesRecursive_pattern()
		{
            ...
            Assert.IsTrue(fi.FullName.EndsWith(System.IO.Path.DirectorySeparatorChar + @"Properties" + System.IO.Path.DirectorySeparatorChar + "AssemblyInfo.txt"));
        }
        [TestMethod]
		public void FindFilesRecursive_Predicate()
		{
            ...
            Assert.IsTrue(f1.FullName.EndsWith(System.IO.Path.DirectorySeparatorChar + @"Properties" + System.IO.Path.DirectorySeparatorChar + "AssemblyInfo.txt"));
        }
